...
public class BoardController extends UiUtils {
	...
	public String modify(@ModelAttribute("params") BoardDTO params, @RequestParam(value = "idx", required = false) Long idx, Model model) {
		if (idx == null) {
			...
			String uploadPath = Paths.get("C:", "Users", "goott7", "sts_web", "ourd-2", "src", "main", "resources", "static", "images").toString();
	...
	public String openBoardDetail(@ModelAttribute("params") BoardDTO params, @RequestParam(value = "idx", required = false) Long idx, Model model) {
		...
		AttachDTO fileInfo = boardService.getAttachDetail(idx);
		 ...
		 if (fileInfo == null || "Y".equals(fileInfo.getDeleteYn())) { throw new
		 RuntimeException("파일 정보를 찾을 수 없습니다."); }
		 
		
		String uploadDate = fileInfo.getInsertTime().format(DateTimeFormatter.ofPattern("yyMMdd"));
		String uploadPath = Paths.get("C:", "Users", "goott7", "sts_web", "ourd-2", "src", "main", "resources", "static", "images").toString();

		String uploadPath2 = Paths.get("C:", "Users", "goott7", "sts_web", "ourd-2", "src", "main", "resources", "static", "images","files").toString();
